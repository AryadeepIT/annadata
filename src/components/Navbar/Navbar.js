...
const Navbar = () => {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
      ...
      <Dropdown.Menu>
        <Dropdown.Item href="#/action-1">Rice, Atta & Dal</Dropdown.Item>
        <Dropdown.Item href="#/action-2">Salt, Sugar & Spices</Dropdown.Item>
        <Dropdown.Item href="#/action-3">Oil & Ghee</Dropdown.Item>
        <Dropdown.Item href="#/action-3">Dry Fruits, Nuts & Seeds</Dropdown.Item>
        <Dropdown.Item href="#/action-3">Snacks & Packaged Food</Dropdown.Item>
        <Dropdown.Item href="#/action-3">Noodles & Pasta</Dropdown.Item>
        <Dropdown.Item href="#/action-3">Beverages</Dropdown.Item>
        <Dropdown.Item href="#/action-3">Detergents & Laundry</Dropdown.Item>
        <Dropdown.Item href="#/action-3">Body & Skincare</Dropdown.Item>
        <Dropdown.Item href="#/action-3">Hair Care</Dropdown.Item>
        <Dropdown.Item href="#/action-3">Women's Hygiene & Baby Care</Dropdown.Item>
